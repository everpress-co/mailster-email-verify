...
class MailsterEmailVerify {
	...
	<div id="message" class="error">
	  <p>
	   <strong>Email Verify for Mailster</strong> requires the <a href="https://mailster.co/?utm_campaign=wporg&utm_source=wordpress.org&utm_medium=plugin&utm_term=Email+Verify+for+Mailster">Mailster Newsletter Plugin</a>, at least version <strong><?php echo MAILSTER_EMAILVERIFY_REQUIRED_VERSION; ?></strong>. Plugin deactivated.
	  </p>
	</div>
		<?php
	}
